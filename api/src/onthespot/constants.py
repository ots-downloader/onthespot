...
class ItemStatus(str, Enum):
    ...
    keeping backwards compatibility with any code that still checks against
    raw string literals.
    """
    ...
    ADDING_TO_M3U = "Adding To M3U"
    DOWNLOADING_SUBTITLES = "Downloading Subtitles"
    DOWNLOADING_CHAPTERS = "Downloading Chapters"
