    ...
    def do_config(self, arg):
        ...
        if len(parts) > 1 and parts[0] == "set":
            try:
                ...
                if key in config.__dict__['_Config__config'] or key in config.__dict__['_Config__template_data']:
                    try:
        ...
        print("\033[32mFix Spotify rate-limited search/downloads with your own Spotify app credentials:\033[0m")
        ...
        print("  \033[36m(create a free app at https://developer.spotify.com/dashboard - Premium required)\033[0m")
